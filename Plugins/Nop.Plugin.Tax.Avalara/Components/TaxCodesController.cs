...
{
    public class TaxCodesController : BasePublicController
    {
        #region Fields
        ...
        public TaxCodesController(IPermissionService permissionService,
        ...
        public ActionResult TaxCodes(string widgetZone, object additionalData)
