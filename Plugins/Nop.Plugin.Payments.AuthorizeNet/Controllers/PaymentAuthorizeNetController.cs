...
namespace Nop.Plugin.Payments.AuthorizeNet.Controllers
{
    public class PaymentAuthorizeNetController : BasePaymentController
    {
        ...
        public ActionResult PaymentInfo()
        {
            ...
            {
                Text = _localizationService.GetResource("Plugins.Payments.AuthorizeNet.Fields.ExpirationDate.Years.Placeholder"),
                Value = "0"
            });

            model.ExpireMonths.Add(new SelectListItem()
            {
                Text = _localizationService.GetResource("Plugins.Payments.AuthorizeNet.Fields.ExpirationDate.Months.Placeholder"),
                Value = "0"
            });
        ...
        public override ProcessPaymentRequest GetPaymentInfo(FormCollection form)
        {
            ...
            paymentInfo.CustomValues.Add("Customer Name", form["CardholderName"]);
