...
namespace Nop.Services.Catalog
{
    ...
    public partial class ProductService : IProductService
    {
        ...
        // y.chan - custom - added manufacturer part number, disabled Full Description search
        ///// <summary>
        ///// Search products
        ///// </summary>
        ...
        //this one is for sevenSpikes  Instant Search compatibility
        /// <summary>
        /// Search products
        /// </summary>
        /// <param name="pageIndex">Page index</param>
            ...
            bool? overridePublished = null)
        {
            ...
            return SearchProducts(out filterableSpecificationAttributeOptionIds, false,
                ...
                storeId, vendorId, warehouseId,
                productType, visibleIndividuallyOnly, markedAsNewOnly, featuredProducts,
                priceMin, priceMax, productTagId, keywords, searchDescriptions, true, searchSku,
                searchProductTags, languageId, filteredSpecs,
                orderBy, showHidden, overridePublished);
        }
        ...
        /// false - load only "Unpublished" products
        /// </param>
        /// <param name="productTemplateId">Product template identifier; 0 to load all records</param>
        /// <returns>Products</returns>
        public virtual IPagedList<Product> SearchProducts(
            out IList<int> filterableSpecificationAttributeOptionIds,
            bool loadFilterableSpecificationAttributeOptionIds = false,
            ...
            int productTemplateId = 0)
        {
            ...
            if (_commonSettings.UseStoredProceduresIfSupported && _dataProvider.StoredProceduredSupported)
            {
                ...
                var pProductTemplateId = _dataProvider.GetParameter();
                pProductTemplateId.ParameterName = "ProductTemplateId";
                pProductTemplateId.Value = productTemplateId;
                pProductTemplateId.DbType = DbType.Int32;
            ...
            else
            {
                ...
                {
                    query = query.Where(p => p.ProductTemplateId == productTemplateId);
                }
