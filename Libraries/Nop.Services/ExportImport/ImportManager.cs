        ...
        public virtual void ImportProductsFromXlsx(Stream stream)
        {
            ...
            using (var xlPackage = new ExcelPackage(stream))
            {
                ...
                while (true)
                {
					...
					/// Added by Kevin
                    decimal ship1 = 0;
                    decimal.TryParse(worksheet.Cells[iRow, GetColumnIndex(properties, "Ship1")].Value.ToString(), out ship1);
                    decimal ship10 = 0;
                    decimal.TryParse(worksheet.Cells[iRow, GetColumnIndex(properties, "Ship10")].Value.ToString(), out ship10);
					/// End Added by Kevin
