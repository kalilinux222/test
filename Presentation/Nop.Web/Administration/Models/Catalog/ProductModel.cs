...
namespace Nop.Admin.Models.Catalog
{
    ...
    public partial class ProductModel : BaseNopEntityModel, ILocalizedModel<ProductLocalizedModel>
    {
		...
		/// Added by Kevin
        [NopResourceDisplayName("Admin.Catalog.Products.Fields.Ship1")]
        public decimal Ship1 { get; set; }

        [NopResourceDisplayName("Admin.Catalog.Products.Fields.Ship10")]
        public decimal Ship10 { get; set; }
        /// End Added by Kevin

        /// Added by Nop-Templates.com
        [NopResourceDisplayName("Admin.Catalog.Products.Fields.HideTierPrice")]
        public bool HideTierPrice { get; set; }
        ...
        public partial class ProductAttributeValueModel : BaseNopEntityModel, ILocalizedModel<ProductAttributeValueLocalizedModel>
        {
            ...
            /// Added by Nop-Templates.com
            [NopResourceDisplayName("Admin.Catalog.Products.ProductAttributes.Attributes.Values.Fields.Ship1")]
            public decimal Ship1 { get; set; }

            [NopResourceDisplayName("Admin.Catalog.Products.ProductAttributes.Attributes.Values.Fields.Ship10")]
            public decimal Ship10 { get; set; }

            [NopResourceDisplayName("Admin.Catalog.Products.ProductAttributes.Attributes.Values.Fields.AttributeValuePicture")]
            [UIHint("Picture")]
            public int AttributeValuePictureId { get; set; }

            [NopResourceDisplayName("Admin.Catalog.Products.ProductAttributes.Attributes.Values.Fields.AttributeValuePicture")]
            public string AttributeValuePictureThumbnailUrl { get; set; }
            /// End Added by Nop-Templates.com
