    ...
    public partial class CategoryController : BaseAdminController
    {
        ...
        public ActionResult Edit(int id)
        {
            ...
            AddLocales(_languageService, model.Locales, (locale, languageId) =>
            {
                ...
                // Added by Kevin
                locale.Description2 = category.GetLocalized(x => x.Description2, languageId, false, false);
                // End Added by Kevin
                // Added by y.chan
                locale.Header1 = category.GetLocalized(x => x.Header1, languageId, false, false);
                // End Added by y.chan
