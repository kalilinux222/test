...
namespace Nop.Admin.Controllers
{
    public partial class ProductController : BaseAdminController
    {
        ...
        public ActionResult List()
        {
            ...
            model.AvailableProductTemplates.Add(new SelectListItem { Text = _localizationService.GetResource("Admin.Common.All"), Value = "0" });
            foreach (var pt in _productTemplateService.GetAllProductTemplates())
                model.AvailableProductTemplates.Add(new SelectListItem { Text = pt.Name, Value = pt.Id.ToString() });
        ...
        public ActionResult ProductList(DataSourceRequest command, ProductListModel model)
        {
            ...
            var products = _productService.SearchProducts(out _,
                ...
                productTemplateId: model.SearchProductTemplateId
            );
        ...
        public ActionResult ProductSpecAttrUpdate(ProductSpecificationAttributeModel model)
        {
            ...
            //Allow filtering is available only for "options"
        ...
        public ActionResult ProductAttributeValueList(int productAttributeMappingId, DataSourceRequest command)
        {
            ...
            var gridModel = new DataSourceResult
            {
                Data = values.Select(x =>
                {
                    ...
                    var attributeValuePictureThumbnailUrl = _pictureService.GetPictureUrl(x.AttributeValuePictureId, 75, false);
                    //little hack here. Grid is rendered wrong way with <inmg> without "src" attribute
                    if (String.IsNullOrEmpty(pictureThumbnailUrl))
                        attributeValuePictureThumbnailUrl = _pictureService.GetPictureUrl(null, 1, true);
                    // End added by Nop-Templates.com
                    ...
                    return new ProductModel.ProductAttributeValueModel
                    {
                        ...
                        Ship1 = x.Ship1,
                        Ship10 = x.Ship10,
                        AttributeValuePictureId = x.AttributeValuePictureId,
                        AttributeValuePictureThumbnailUrl = attributeValuePictureThumbnailUrl
                    };
                }),
                Total = values.Count()
            };
        ...
        public ActionResult ProductAttributeValueCreatePopup(string btnId, string formId, ProductModel.ProductAttributeValueModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                var pav = new ProductAttributeValue
                {
                    ...
                    Ship1 = model.Ship1,
                    Ship10 = model.Ship10,
                    AttributeValuePictureId = model.AttributeValuePictureId
                };
        ...
        public ActionResult ProductAttributeValueEditPopup(int id)
        {
            ...
            var model = new ProductModel.ProductAttributeValueModel
            {
                ...
                Ship1 = pav.Ship1,
                Ship10 = pav.Ship10,
                AttributeValuePictureId = pav.AttributeValuePictureId
            };
        ...
        public ActionResult ProductAttributeValueEditPopup(string btnId, string formId, ProductModel.ProductAttributeValueModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                // Added by Nop-Templates.com
                pav.Ship1 = model.Ship1;
                pav.Ship10 = model.Ship10;
                pav.AttributeValuePictureId = model.AttributeValuePictureId;
