    ...
    public partial class ProductController : BasePublicController
    {
            ...
            ShoppingCartItem updatecartitem = null, bool isAssociatedProduct = false)
        {
            ...
            var model = new ProductDetailsModel
            {
                ...
                HideTierPrice = product.HideTierPrice // Added by Nop-Templates.com
            };
            ...
            var cachedPictures = _cacheManager.Get(productPicturesCacheKey, () =>
            {
                ...
                var defaultPictureModel = new PictureModel
                {
                    ...
                    Title = string.Format(_localizationService.GetResource("Media.Product.ImageLinkTitleFormat.Details"), model.ShortDescription),
                    //y.chan - custom - end
                ...
                defaultPictureModel.Title = (defaultPicture != null && !string.IsNullOrEmpty(defaultPicture.TitleAttribute)) ?
                    ...
                    string.Format(_localizationService.GetResource("Media.Product.ImageLinkTitleFormat.Details"), model.ShortDescription);
                    //y.chan - custom - end
                //"alt" attribute
            ...
            if (Request.FilePath == "/GetMiniProductDetailsView" && Request.QueryString.HasKeys())
            {
                var queryString = System.Web.HttpUtility.ParseQueryString(Request.QueryString.ToString());

                if (queryString["updatecartitemid"] != null && int.TryParse(Request["updatecartitemid"], out int updatecartitemid))
                {
        ...
        protected virtual void PrepareProductReviewsModel(ProductReviewsModel model, Product product)
        {
            ...
            var productReviews = product.ProductReviews.Where(pr => pr.IsApproved).OrderByDescending(pr => pr.CreatedOnUtc);
