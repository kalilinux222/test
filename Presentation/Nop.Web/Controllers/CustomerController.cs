...
namespace Nop.Web.Controllers
{
    public partial class CustomerController : BasePublicController
    {
        ...
        public ActionResult Register()
        {
            ...
            {
                CountryId = usaCountryId //set default country to be USA
            };
        ...
        public ActionResult Register(RegisterModel model, string returnUrl, bool captchaValid, FormCollection form)
        {
            ...
            if (ModelState.IsValid)
            {
                // prevent bots from registering (most of them register with company name "google")
                if (string.Equals(model.Company, "google", StringComparison.OrdinalIgnoreCase))
                {
                    return RedirectToRoute("HomePage");
                }
